...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> Fsharp.Giraffe.AzureCosmos.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> Fsharp.Giraffe.AzureCosmos.App.configureServices)
